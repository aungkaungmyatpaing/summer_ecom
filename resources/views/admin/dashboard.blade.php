    ...
    <div class="row">
        <div class="col-md-3">
          <div class="card card-body bg-primary text-white mb-3">
            ...
            <h1>{{ $totalOrder }}</h1>
            <a href="{{ url('/admin/orders') }}" class="text-white text-decoration-none">view</a>
          </div>
        </div>
        <div class="col-md-3">
    ...
    <div class="row">
      <div class="col-md-3">
        <div class="card card-body bg-primary text-white mb-3">
          ...
          <h1>{{ $totalProducts }}</h1>
          <a href="{{ url('/admin/product') }}" class="text-white text-decoration-none">view</a>
        </div>
      </div>
      <div class="col-md-3">
        <div class="card card-body bg-success text-white mb-3">
      ...
      <div class="col-md-3">
        <div class="card card-body bg-warning text-white mb-3">
          ...
          <h1>{{ $totalBrands }}</h1>
          <a href="{{ url('/admin/brand') }}" class="text-white text-decoration-none">view</a>
        </div>
      </div>
    </div>
    <hr>
