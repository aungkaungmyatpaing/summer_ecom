<div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <p>
                            {{ $appSetting->meta_description ?? 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.
    ...
    <div class="copyright-area">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <p class=""> &copy; 2023 - MaG DoG - Ecommerce. All rights reserved.</p>
                </div>
                <div class="col-md-4">
                    <div class="social-media">
                        Get Connected:
                        @if($appSetting->facebook)
                            <a href="{{ $appSetting->facebook }}" target="_blank"><i class="fa fa-facebook" target="_blank"></i></a>
                        @endif 
                        @if($appSetting->twitter)
                            <a href="{{ $appSetting->twitter }}" target="_blank"><i class="fa fa-twitter" target="_blank"></i></a>
                        @endif
                        @if($appSetting->instagram)
                            <a href="{{ $appSetting->instagram }}" target="_blank"><i class="fa fa-instagram" target="_blank"></i></a>
                        @endif
